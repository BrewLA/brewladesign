        ...
        <div className="w-[620px] flex flex-row justify-between">
            <div className={`flex flex-col gap-9 ${alignmentClass}`}>
                <div className="flex flex-col gap-3">
                    <h2 className="text-gray-300 dark:text-gray-500">{heading}</h2>
                ...
                <ul className="flex flex-col gap-3">
                    {listItems.map((item, index) => (
                        <li key={index} className="flex flex-row gap-3 items-center h-9 text-xl tracking-[-0.50px] text-gray-300 dark:text-gray-500">
                            <Image
                                src="/images/star.svg"
                                alt="star icon"
                                width={24}
